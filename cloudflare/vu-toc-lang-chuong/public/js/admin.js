/* Admin CRUD MVP — Vũ Tộc Làng Chuông */
(function () {
  "use strict";
  ...
  function loadPersonIntoForm(person) {
    ...
    el("parentChildId").value = person.id;
    el("spouseA").value = person.id;
  }
  ...
  function savePerson() {
    ...
    req
      .then(function (data) {
        ...
        // Normalize create response keys if snake/camel mix
        var normalized = {
          id: person.id,
          name: person.name,
          ...
          birthOrder: person.birthOrder != null ? person.birthOrder : person.birth_order,
          ...
          personCode: person.personCode != null ? person.personCode : person.person_code,
